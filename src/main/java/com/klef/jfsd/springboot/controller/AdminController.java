...
public class AdminController 
{
	...
	public ModelAndView viewallprojsdemo()
	{
	 ...
	 @GetMapping("/mentorreg")
	    ...
	    public String saveUpdatedStudent(@ModelAttribute("student") Student student, Model model) {
	    ...
	    public String showUpdateMentorForm(@RequestParam("id") int id, Model model) {
	        Mentor mentor = adminService.getMentorById(id);
	        model.addAttribute("mentor", mentor);
	        return "updatementor";
	    }

	    @PostMapping("/savementor")
	    public String saveUpdatedMentor(@ModelAttribute("mentor") Mentor mentor, Model model) {
	        adminService.updateMentor(mentor);
	        model.addAttribute("message", "Mentor updated successfully!");
	        return "redirect:viewallmentors";
	    }
}
