...
<div class="container">
    ...
    <div class="button-container">
        <a href="registermentor.jsp">Add New Mentor</a>
    </div>
</div>
</body>
</html>
            ...
            <table>
                ...
                <c:forEach items="${mentorlist}" var="mentor" varStatus="status">
                    <tr style="animation-delay: ${status.index * 0.1}s">
                        ...
                        <td><c:out value="${mentor.salary}"/></td>
                        <td><c:out value="${mentor.location}"/></td>
                        <td><c:out value="${mentor.email}"/></td>
                        <td><c:out value="${mentor.contact}"/></td>
                        <td><c:out value="${mentor.password}"/></td>
                        <td><c:out value="${mentor.status}"/></td>
                       
                        <td>
                            <a href="updatementor?id=${mentor.id}">Update</a>
